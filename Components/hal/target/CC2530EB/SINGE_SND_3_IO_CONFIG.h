#ifndef SINGE_SND_3_IO_CONFIG_H
#define SINGE_SND_3_IO_CONFIG_H
...
//老版本
#define OUT1_BV           BV(7)            //火线切换
#define OUT1_SBIT         P0_7             
#define OUT1_DDR          P0DIR            
#define OUT1_POLARITY     ACTIVE_HIGH   


#define OUT2_BV           BV(4)            //火线控制端
#define OUT2_SBIT         P1_4            
#define OUT2_DDR          P1DIR            
#define OUT2_POLARITY     ACTIVE_HIGH 


//老版本
#define OUT3_BV           BV(0)            //火线控制端
#define OUT3_SBIT         P0_0            
