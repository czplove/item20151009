...
#define HAL_KEY_SW_8_ICTLBIT  BV(3) /* P1IEN - P1.2 enable/disable bit */ 
...
uint8     key_p1_4_ISR_FLAG = 0;//test 测试单击 双击等程序
uint8     key_double_P1_4_flag =0;
...
void HalKeyPoll (void)
{
 ...
 if ((HAL_KEY_JOY_MOVE_PORT & HAL_KEY_JOY_MOVE_BIT))  /* Key is active HIGH */
  ...
  //  keys |= HAL_KEY_SW_9;
     ...
     key_p1_4_ISR_FLAG++;//test 测试单击 双击等程序
...
void HalKeyMultiClickCheck(void)
{
 ...
 {  
  ...
  {  
      keys |= HAL_KEY_SW_9;
      key_double_P1_4_flag=key_p1_4_ISR_FLAG;
