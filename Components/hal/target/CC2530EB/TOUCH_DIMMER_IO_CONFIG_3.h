#ifndef TOUCH_DIMMER_IO_CONFIG_3_H
#define TOUCH_DIMMER_IO_CONFIG_3_H
...
#define TG_OUT_3_BV           BV(3) //PUSLE OUT
#define TG_OUT_3_SBIT         P0_3
#define TG_OUT_3_DDR          P0DIR
#define TG_OUT_3_POLARITY     ACTIVE_HIGH
