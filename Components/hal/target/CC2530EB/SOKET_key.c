...
/* edge interrupt */
#define HAL_KEY_SW_8_EDGEBIT  BV(1)//p1端口的触发模式设置 在PICTL的低第三位（位2）
...
/* edge interrupt */
#define HAL_KEY_SW_7_EDGEBIT  BV(2)//p1端口的触发模式设置 在PICTL的低第二位（位1）
...
#define HAL_KEY_SW_7_ICTLBIT  BV(4) /* P1IEN - P1.3 enable/disable bit */ 
