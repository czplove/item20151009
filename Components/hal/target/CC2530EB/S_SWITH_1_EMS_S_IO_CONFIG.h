#ifndef S_SWITH_1_EMS_S_IO_CONFIG_H
#define S_SWITH_1_EMS_S_IO_CONFIG_H

//添加的输出
#define LED1_BV           BV(0)//BV(2)
#define LED1_SBIT         P1_0//P2_2
#define LED1_DDR          P1DIR//P2DIR
#define LED1_POLARITY     ACTIVE_LOW	//20110721 ACTIVE_HIGH

#define LED2_BV           BV(0)//BV(1)
#define LED2_SBIT         P1_0//P2_1
#define LED2_DDR          P1DIR// P2DIR//P0DIR//P2DIR
...
#define LED5_BV           BV(1)// BV(1)
#define LED5_SBIT          P2_1//P2_1
#define LED5_DDR           P2DIR//P2DIR
