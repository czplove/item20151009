...
#define HAL_KEY_SW_6_ICTLBIT  BV(2) /* P1IEN - P1.4 enable/disable bit BV(1)*/
#define HAL_KEY_SW_6_PXIFG    P1IFG /* Interrupt flag at source */


/* SW_8 is at P1.5 */             //打开到极限位置
#define HAL_KEY_SW_8_PORT   P1
#define HAL_KEY_SW_8_BIT    BV(5)
...
#define HAL_KEY_SW_8_EDGE     HAL_KEY_RISING_EDGE  // 
/* SW_8 interrupts */
...
#define HAL_KEY_SW_8_ICTLBIT  BV(5) /* P1IEN - P1.5 enable/disable bit */ 
#define HAL_KEY_SW_8_PXIFG    P1IFG /* Interrupt flag at source */
#define HAL_KEY_SW_8_1INP     P1INP
#define HAL_KEY_SW_8_1INPBIT  BV(5)
#define HAL_KEY_SW_8_2INP     P2INP
#define HAL_KEY_SW_8_2INPBIT  BV(6)


/* SW_9 is at P1.6 */            //关闭到极限位置
#define HAL_KEY_SW_9_PORT   P1
#define HAL_KEY_SW_9_BIT    BV(6)
...
#define HAL_KEY_SW_9_EDGE     HAL_KEY_RISING_EDGE  // 
/* SW_9 interrupts */
...
#define HAL_KEY_SW_9_ICTLBIT  BV(6) /* P1IEN - P1.5 enable/disable bit */ 
#define HAL_KEY_SW_9_PXIFG    P1IFG /* Interrupt flag at source */
#define HAL_KEY_SW_9_1INP     P1INP
#define HAL_KEY_SW_9_1INPBIT  BV(6)
#define HAL_KEY_SW_9_2INP     P2INP
#define HAL_KEY_SW_9_2INPBIT  BV(6)
...
void HalKeyInit( void )
{
  ...
  HAL_KEY_SW_6_SEL &= ~(HAL_KEY_SW_6_BIT);    /* Set pin function to GPIO */   //P1.2
  HAL_KEY_SW_6_DIR &= ~(HAL_KEY_SW_6_BIT);    /* Set pin direction to Input */
  
  HAL_KEY_SW_8_SEL &= ~(HAL_KEY_SW_8_BIT);    /* Set pin function to GPIO */  //P1.5
  HAL_KEY_SW_8_DIR &= ~(HAL_KEY_SW_8_BIT);    /* Set pin direction to Input */
//  HAL_KEY_SW_8_1INP &= ~ HAL_KEY_SW_8_1INPBIT;  /* Set pin pull/down*/
  HAL_KEY_SW_8_2INP |= HAL_KEY_SW_8_2INPBIT;  /* Set pin down*/
  
  HAL_KEY_SW_9_SEL &= ~(HAL_KEY_SW_9_BIT);    /* Set pin function to GPIO */   //P1.6
  HAL_KEY_SW_9_DIR &= ~(HAL_KEY_SW_9_BIT);    /* Set pin direction to Input */
//  HAL_KEY_SW_9_1INP &= ~ HAL_KEY_SW_9_1INPBIT;  /* Set pin pull/down*/
  HAL_KEY_SW_9_2INP |= HAL_KEY_SW_9_2INPBIT;  /* Set pin down*/
...
void HalKeyPoll (void)
{
 uint8 keys = 0;
  ...
  else
  {
   ...
   if ((key_ISR_FLAG==HAL_KEY_SW_9) && (HAL_PUSH_BUTTON6()))//初步理解，设置p1.6为上升沿触发，触发唤醒系统后，25ms到这，判断是否为1，是1则读取见键值
   {
    keys |= HAL_KEY_SW_9;
   }
  
   else if ((key_ISR_FLAG==HAL_KEY_SW_8) && (HAL_PUSH_BUTTON5()))//初步理解，设置p1.5为上升沿触发，触发唤醒系统后，25ms到这，判断是否为0，是0则读取见键值
   {
    keys |= HAL_KEY_SW_8;
   }
  
   else if ((key_ISR_FLAG==HAL_KEY_SW_6) && (!(HAL_PUSH_BUTTON4())))//初步理解，设置p1.2为下降沿触发，触发唤醒系统后，25ms到这，判断是否为1，是1则读取见键值
   {
   //  keys |= HAL_KEY_SW_6;
...
//    P1DIR &= ~0X20;//INput
 ...
 if (HAL_KEY_SW_6_PXIFG & HAL_KEY_SW_6_BIT)//p1.2中断标志
  {
    halProcessKeyInterrupt();
     HAL_KEY_SW_6_PXIFG = 0; //清除p1.2标志
     key_ISR_FLAG =HAL_KEY_SW_6;
  }

  else if(HAL_KEY_SW_8_PXIFG & HAL_KEY_SW_8_BIT)//p1.4中断标志
  {
     halProcessKeyInterrupt();
     HAL_KEY_SW_8_PXIFG = 0;//清除p1.4标志
     key_ISR_FLAG =HAL_KEY_SW_8;
     
  }
 
 else  if (HAL_KEY_SW_9_PXIFG & HAL_KEY_SW_9_BIT)//p1.5中断标志
  {
    halProcessKeyInterrupt();
