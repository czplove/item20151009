...
#define HAL_PUSH_BUTTON3()        (PUSH3_POLARITY (PUSH3_SBIT)) //(0)
#define HAL_PUSH_BUTTON4()        (PUSH4_POLARITY (PUSH4_SBIT))//(0)
#define HAL_PUSH_BUTTON5()        (PUSH5_POLARITY (PUSH5_SBIT))//(0)
#define HAL_PUSH_BUTTON6()        (PUSH6_POLARITY (PUSH6_SBIT))//(0)
#define HAL_PUSH_BUTTON7()        (PUSH7_POLARITY (PUSH7_SBIT))//(0)
