...
/* SW_8 is at P1.2 */
#define HAL_KEY_SW_8_PORT   P2
#define HAL_KEY_SW_8_BIT    BV(0)
#define HAL_KEY_SW_8_SEL    P2SEL
#define HAL_KEY_SW_8_DIR    P2DIR
/* edge interrupt */
#define HAL_KEY_SW_8_EDGEBIT  BV(3)//p1端口的触发模式设置 在PICTL的低第二位（位1）
#define HAL_KEY_SW_8_EDGE     HAL_KEY_FALLING_EDGE  // 
/* SW_8 interrupts */
#define HAL_KEY_SW_8_IEN      IEN2  /* CPU interrupt mask register */
#define HAL_KEY_SW_8_IENBIT   BV(1) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_8_ICTL     P2IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_8_ICTLBIT  BV(0) /* P1IEN - P1.2 enable/disable bit */ 
#define HAL_KEY_SW_8_PXIFG    P2IFG /* Interrupt flag at source */
