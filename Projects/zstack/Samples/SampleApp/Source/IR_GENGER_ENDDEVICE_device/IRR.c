...
uint16 EdgeTimeSlot;   
uint16 EdgeTimeSlot_LR[800];   //边沿时间间隔= EdgeTimeSlot_LRsl * us10Cnt + EdgeTimeSlot_HRsl
uint16 EdgeTimeSlot_LRsl = 0;   //边沿时间间隔 低分辨率  10us

uint8  EdgeTimeSlot_HR[800];   //边沿时间间隔 高分辨率  0.125us
...
void Hal_SPI_Init(void)
{
  ...
  U0BAUD = 0xFF;//216;
  U0GCR  = 0x30;	//这个决定A.波特率的分配值,B.LSB还是MSB,C.时钟相位还是极性
  //设置时钟为11059200
}
