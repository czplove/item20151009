...
void HalKeyPoll (void)
{
 ...
 //  #endif
  ...
  else
  {
    ...
    if ((key_ISR_FLAG==HAL_KEY_SW_6) && (!HAL_PUSH_BUTTON4()))//初步理解，设置p0.4为下降沿触发，触发唤醒系统后，25ms到这，判断是否为0，是0则读取见键值
   {
    keys |= HAL_KEY_SW_6;
   }
...
HAL_ISR_FUNCTION( halKeyPort0Isr, P0INT_VECTOR )
{
  ...
  else if(HAL_KEY_SW_5_PXIFG & HAL_KEY_SW_5_BIT)
  {
    halProcessKeyInterrupt();
  //  key_ISR_FLAG =HAL_KEY_SW_05;
  }
  /*
