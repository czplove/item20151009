...
void LED_TEST_blink_init(void);

void LED_TEST_blink_init(void)
{
#if defined (SR_PIR) || (IR_GENERAL)
  ...
  #elif defined (SR_S_BSL_3) ||(SR_S_BSL_2)||(SR_S_BSL_1)
...
void  hal_gpio_Init(void)
{
   ...
   LED_TEST_blink_init();
 //  HalKeyInit();
 //  HalKeyConfig(HAL_KEY_INTERRUPT_ENABLE , NULL);
